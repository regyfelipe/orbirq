...
import 'package:orbirq/models/home_item.dart';
...
class UltimoAcessoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final UserUltimoAcesso acesso = UserUltimoAcesso.fromMap(ultimoAcesso.data!);
